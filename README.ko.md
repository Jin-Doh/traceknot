...
번들된 Verify CLI가 두 옴브리게이션 매니페스트를 끝까지 실행하는 실제 동작입니다. 증거 수집, PASS 판정, 세션 QA 보드 발행까지 그대로 녹화되어 있습니다.

![Traceknot Verify CLI가 명시적 커맨드 매니페스트를 수집하고 PASS 판정과 세션 QA 보드 발행까지 수행하는 장면](assets/readme/traceknot-verify.gif)
