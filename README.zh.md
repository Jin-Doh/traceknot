...
| OMP、Codex、Claude Code、OpenCode 或 GajaeCode 原生 adapter | **尚未实现。** 当前仅提供 Codex capability envelope 验证 primitive，不提供原生 transport 或 invocation；仅凭宿主名称不会获得 capability |
