...
该 gate 会验证 installer lifecycle、schema、capability record、prompt-injection 风险、发布文案、测试、strict TypeScript 和 whitespace 完整性。`bun run prose-quality` 只为韩文和英文发布文案生成 advisory report；它不会把其他语言套用到错误的规则上。
