...
function protectedValues(text: string): Map<string, { category: string; count: number }> {
  const categories: Array<[string, RegExp]> = [
    ...
    ["number", /(?<![唯统])(?:零|〇|一|二|两|三|四|五|六|七|八|九|十|百|千|万|亿)+(?:点(?:零|〇|一|二|三|四|五|六|七|八|九)+)?\s*(?:至|到|[-–—])\s*(?:零|〇|一|二|两|三|四|五|六|七|八|九|十|百|千|万|亿)+(?:点(?:零|〇|一|二|三|四|五|六|七|八|九)+)?(?=\s*(?:个|次|名|件|条|份|年|月|日|小时|分钟|秒|台|套|页|章|倍))/g],
    ["number", /(?<![唯统])(?:零|〇|一|二|两|三|四|五|六|七|八|九|十|百|千|万|亿)+(?:点(?:零|〇|一|二|三|四|五|六|七|八|九)+)?(?=\s*(?:个|次|名|件|条|份|年|月|日|小时|分钟|秒|台|套|页|章|倍))/g],
