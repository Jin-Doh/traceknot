...
| Native OMP, Codex, Claude Code, OpenCode, or GajaeCode adapters | **Not implemented.** A Codex capability-envelope validation primitive is available, but it does not provide native transport or invocation. A host name alone grants no capability |
