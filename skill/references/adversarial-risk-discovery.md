...
The host capability contract remains `quality-capability/v1`: the two canonical profile capabilities are optional for backward compatibility in stored adapter records, but any new discovery runtime record must declare both booleans explicitly.
