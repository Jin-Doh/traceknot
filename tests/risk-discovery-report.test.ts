...
describe("risk discovery report contract", () => {
  ...
  const negativeFixtures = [
    ...
    ["risk-discovery-report.invalid-profile-promoted-missing-obligation-id.json", "PROMOTED profile resolution without obligation ID"],
    ["risk-discovery-report.invalid-profile-no-findings-foreign-obligation-id.json", "NO_FINDINGS profile resolution with foreign obligation ID"],
    ["risk-discovery-report.invalid-profile-accepted-risk-foreign-obligation-id.json", "ACCEPTED_RISK profile resolution with foreign obligation ID"],
